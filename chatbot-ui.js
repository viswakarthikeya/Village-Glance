...
function init() {
    ...
    <div class='chat-popup'>
		...
		<div class='chat-input-area'>
			<input type='text' autofocus class='chat-input' onkeypress='return givenUserInput(event)' placeholder='Type a message ...' autocomplete='off' id="inputt">
			<button class='chat-submit'><i class='material-icons'>send</i></button>
            <button class='voice-input'>speak</button>
		</div>
